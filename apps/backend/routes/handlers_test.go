...
type MockQuerier struct {
	...
	DeleteWorkflowByIdFn              func(ctx context.Context, arg database.DeleteWorkflowByIdParams) error
...
func (m *MockQuerier) DeleteWorkflowById(ctx context.Context, arg database.DeleteWorkflowByIdParams) error {
	if m.DeleteWorkflowByIdFn != nil {
		return m.DeleteWorkflowByIdFn(ctx, arg)
	}
	return nil
}
